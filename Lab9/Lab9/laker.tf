...
tfLayoutMagicCell {
  device {
    ...
    ruleDef {
      ...
      { minChannelWidth 0.5 }
      { minGateSpace {0.25} }
      { minOd2GateExtension 0.25 }
      { minPoly2GateExtension {0.2} }
      { minCo2OdEnclosure {0.12} }
      { minCoSpace {0.25} }
      { minCo2GateSpace {0.14} }
      { minCoWidth 0.23 }
      { minCo2MetEnclosure 0.08 }
      { minOd2PolySpace 0.25 }
      { minOdWidth 0.25 }
      { minOdNotch 0.3 }
      { minMetSpace 0.24 }
      { minOdSpace 0.3 }
...
expr $C1*$area+$C2*$peri
  ...
  contactDevice {
    ...
    ruleDef {
      ...
      { minCo2Lay2RangeEnclosure { 0.125 0.125 } }
    }
  }
  contactDevice {
